...
import sambal.mydd.app.databinding.MyVoucherListAdapterBinding
...
class MyVoucherListAdapter(var context: Context, private val list: List<AgentVoucherListBean>, private val agentWalletType:String?, val agentId:String, private val type:String?) :
    RecyclerView.Adapter<MyVoucherListAdapter.MyViewHolder>() {
    var dialogManager: DialogManager? = null

    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): MyViewHolder {
        val binding =
            MyVoucherListAdapterBinding.inflate(LayoutInflater.from(parent.context), parent, false)
    ...
    inner class MyViewHolder(var binding: MyVoucherListAdapterBinding) : RecyclerView.ViewHolder(
        binding.root)
                    ...
                    if (response.isSuccessful) {
                        try {
                            ...
                            if (errorType == KeyConstant.KEY_RESPONSE_CODE_200) {
                                ...
                                /*context.showQRCODE(responseObj, refreshCard)*/
                            }
