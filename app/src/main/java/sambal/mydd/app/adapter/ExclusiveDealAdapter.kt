...
import sambal.mydd.app.databinding.ExclusiveDealsAdapterBinding
...
class ExclusiveDealAdapter(
    var context: Context,
    var CustomerLists: List<DailyDeals>,
    var Check: String,
    var Search: String,
    var exclusive_dialog: Dialog
) : RecyclerView.Adapter<ExclusiveDealAdapter.MyViewHolder>() {
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): MyViewHolder {
        return if (Search == "") {
            val itemView =
                DailyDealAdapterBinding.inflate(
                    LayoutInflater.from(
                    parent.context), parent, false)
            MyViewHolder(itemView)
        } else if (Search == "popup") {
            val itemView =
                ExclusiveDealsAdapterBinding.inflate(
            ...
            val itemView1 =
                SearchDailyDealAdapterBinding.inflate(
                    LayoutInflater.from(
                    parent.context), parent, false)
            MyViewHolder(itemView1)
        }
        /* View vh = new ExclusiveDealAdapter.MyViewHolder(itemView);*/
    }
    ...
    override fun onBindViewHolder(holder: MyViewHolder, position: Int) {
        ...
        if (Search == "") {
            ...
            holder.binding!!.rootLayout.setOnClickListener {
                if (Search == "") {
                    ErrorMessage.E("ExclusiveDealAdapter 1")
            ...
            holder.binding12!!.llAgent.setOnClickListener(View.OnClickListener {
                ...
                context.startActivity(
                    Intent(context, New_AgentDetails::class.java)
                    .putExtra("agentId", hd.productAgentId.toString())
                    .putExtra("direct", "exclusive_popup"))
            })
            if (hd.productDiscountPercentageEnabled == 0 && hd.priceEnabledId == 0 && hd.discountPriceEnabledId == 0) {
            } else if (hd.productDiscountPercentageEnabled == 0 && hd.priceEnabledId == 1 && hd.discountPriceEnabledId == 0) {
            ...
            holder.binding12!!.rootLayout.setOnClickListener {
                if (Search == "") {
                    ErrorMessage.E("ExclusiveDealAdapter 2")
                    (context as NewMyDealsActivity).moveToDetails(hd.productId.toString() + "",
                        hd.productAgentId.toString() + "",
                        position)
                } else if (Search == "popup") {
                    ...
                    intent.putExtra(
                        IntentConstant.INTENT_KEY_AGENT_ID,
                        hd.productAgentId.toString())
                   // intent.putExtra("type", "non_direct")
                    intent.putExtra("type", "exclusive_popup")
                    intent.putExtra("pos", "")
                    context.startActivity(intent)
                } else {
                    ErrorMessage.E("ExclusiveDealAdapter 3")
                    (context as SearchAllDealActivity).moveToDetails(hd.productId.toString() + "",
                        hd.productAgentId.toString() + "",
                        position)
                }
            ...
            try{
                if (hd.productType!=null && hd.productTypeColor!=null){
                    holder.binding12!!.activeStausTv.setText(hd.productType)
                    holder.binding12!!.activeStausTv.setTextColor(Color.parseColor(hd.productTypeColor))
                }
                if (hd.productTypeText!=null ){
                    holder.binding12!!.exclusiveTv.setText(hd.productTypeText)
                }
            ...
            holder.binding1!!.rootLayout.setOnClickListener {
                if (Search == "") {
                    ErrorMessage.E("ExclusiveDealAdapter 4")
                    (context as NewMyDealsActivity).moveToDetails(hd.productId.toString() + "",
                        hd.productAgentId.toString() + "",
                        position)
                } else {
...
*/
    ...
    inner class MyViewHolder : RecyclerView.ViewHolder {
        ...
        var binding12: ExclusiveDealsAdapterBinding? = null
        ...
        constructor(view: ExclusiveDealsAdapterBinding) : super(view.root) {
            binding12 = view
        }
    }
