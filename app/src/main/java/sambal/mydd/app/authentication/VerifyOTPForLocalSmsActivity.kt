...
import sambal.mydd.app.databinding.ActivityVerifyOtpforLocalSmsBinding
...
class VerifyOTPForLocalSmsActivity : AppCompatActivity(), View.OnClickListener,
    MySMSBroadcastReceiver.OTPReceiveListener {
    private var binding: ActivityVerifyOtpforLocalSmsBinding? = null
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = DataBindingUtil.setContentView(this, R.layout.activity_verify_otpfor_local_sms)
        context = this@VerifyOTPForLocalSmsActivity
...
//                verifyCode(otp)
    ...
    private fun checkValidation() {
        if (otp.equals("", ignoreCase = true)) {
            ...
            Toast.makeText(this@VerifyOTPForLocalSmsActivity, "Please Enter OTP", Toast.LENGTH_SHORT).show()
            return
        } else if (!AppUtil.isNetworkAvailable(this@VerifyOTPForLocalSmsActivity)) {
            AppUtil.hideSoftKeyboard(context)
            Toast.makeText(this@VerifyOTPForLocalSmsActivity, "No Internet", Toast.LENGTH_SHORT).show()
            return
        } else {
            AppUtil.hideSoftKeyboard(context)
...
//            verifyCode(otp)
    ...
    private fun callVerificationCode() {
        ...
        if (AppUtil.isNetworkAvailable(context)) {
            ...
            val call = AppConfig.api_Interface().numberVerification(otp)
...
//                send_OTP= verificationId.toString()
            ...
            override fun onVerificationFailed(e: FirebaseException) {
                ...
                Toast.makeText(this@VerifyOTPForLocalSmsActivity, e.message, Toast.LENGTH_LONG).show()
            }
        }
...
//                                                "+$userCountryCode $userMobile"
                                            ...
                                            Toast.makeText(this@VerifyOTPForLocalSmsActivity,
                                                "Succesfull register",
                                                Toast.LENGTH_LONG).show()
                                            PreferenceHelper.getInstance(context)?.isLogin = true
                                            val i = Intent(this@VerifyOTPForLocalSmsActivity, MainActivity::class.java)
                                                .putExtra("deals", "4")
...
//                                            startActivity(intent1)
                                    ...
                                    try {
                                        ...
                                        SharedPreferenceVariable.deletePreferenceData(this@VerifyOTPForLocalSmsActivity,
                                            KeyConstant.Shar_Email)
                                        SharedPreferenceVariable.savePreferences(this@VerifyOTPForLocalSmsActivity,
                                            KeyConstant.Shar_Name,
                                            responseObj!!.optString("userName"))
                                        SharedPreferenceVariable.savePreferences(this@VerifyOTPForLocalSmsActivity,
                                            KeyConstant.KEY_USER_ID,
