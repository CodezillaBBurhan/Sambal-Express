...
public class EventDetail implements Serializable {
    ...
    @SerializedName("eventSeconds")
    @Expose
    private Integer eventSeconds;
    @SerializedName("eventClubPoints")
    @Expose
    private Integer eventClubPoints;
    ...
    public Integer getEventClubPoints() {
        return eventClubPoints;
    }

    public void setEventClubPoints(Integer eventClubPoints) {
        this.eventClubPoints = eventClubPoints;
    }
